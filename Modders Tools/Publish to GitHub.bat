...
set "REPO_DIR=%TOOLS_DIR%_repo_cache\Hoenn-Reloaded-Mods"
...
if not exist "%TOOLS_DIR%_repo_cache" mkdir "%TOOLS_DIR%_repo_cache"
...
color 0E
echo.
echo Push failed. The commit exists locally at:
echo %REPO_DIR%
echo.
echo If you do not have collaborator access, open a pull request from this repo cache.
echo.
pause
exit
