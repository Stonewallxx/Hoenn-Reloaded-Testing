...
if defined?(PokemonLoadScreen)
  class PokemonLoadScreen
    def pbStartLoadScreen
      ...
      links_available = !defined?(Reloaded::Platform) || Reloaded::Platform.supports?(:open_url)
      if links_available && Settings::HOENN && new_game_plus && !Settings::FEEDBACK_FORM_URL.empty?
      ...
      loop do
        ...
        when cmd_right
          ...
          if cmd_links.key?(command)
            Reloaded::Platform.open_url(cmd_links[command])
          else
            pbPlayBuzzerSE
          end
        end
  ...
  Reloaded::Patches.register(
    ...
    type: :replace,
    file: "Reloaded/Core/UI/TitleMenu.rb",
